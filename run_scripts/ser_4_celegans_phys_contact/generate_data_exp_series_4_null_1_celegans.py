...
if __name__ == "__main__":
    '''
    IDEA:
    Pick 80% of all available i nodes from Sensory
    Pick 80% of all available i nodes from Muscle
    In the input matrix w_in, those nodes are set to uniform[0,1]
    Rewire connectiones
    '''
    
    exp_series_name = 'exp_series_4_null_1_celegans_phys_contact'
    ...
    series_config['DEFAULT'] = {
                                ...
                                'SERIES_DESCRIPTION' : 'Individual (per DIV), Random 80%, Uniform I/O Nodes',
    ...
    for experiment in experiments:
        for age in ['01','02','03','04','05','06','07']:
            ...
            for i in range(number):
                ...
                n_input_nodes = (int(0.8*len(input_nodes)) // task.n_features) * task.n_features
                ...
                n_output_nodes = int(0.8*len(output_nodes))
